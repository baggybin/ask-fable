...
def test_schema_wired():
    ...
    # context_pack is now a legacy alias folded into context(op="pack"); the
    # description constant still lives in prompts.
    assert "Point, don't paste" in prompts.CONTEXT_PACK_TOOL_DESCRIPTION
